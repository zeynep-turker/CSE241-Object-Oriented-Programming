...
Triangle::Triangle(int Line) {
    ...
    setPositionT1(Line/2,0);
    setPositionT2(0,(Line/2)*sqrt(3));
    setPositionT3(Line,(Line/2)*sqrt(3));        
}
...
void Triangle::setSize(int num){
    ...
    totalArea += area;
    totalPerimeter +=perimeter;
    setPositionT1(num/2,0);
    setPositionT2(0,(num/2)*sqrt(3));
    setPositionT3(num,(num/2)*sqrt(3));
}
